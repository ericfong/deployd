...
// // XXX: remove bad fields starting with $
// var allow$fields = ['$addToSet', '$pop'];
// Store.prototype.sanitize = function (object) {
//     for (var k in object) {
//         if (k[0] == '$' && allow$fields.indexOf(k) < 0) {
//             delete object[k];
//         }
//     }
//     return object;
